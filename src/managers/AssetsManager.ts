...
export default class AssetsManager {
  public preload(scene: Phaser.Scene) {
    ...
    scene.load.image("enemy-1_frame-1", enemy1Frame1);
    scene.load.image("enemy-1_frame-2", enemy1Frame2);
    scene.load.image("enemy-2_frame-1", enemy2Frame1);
    scene.load.image("enemy-2_frame-2", enemy2Frame2);
    scene.load.image("enemy-3_frame-1", enemy3Frame1);
    scene.load.image("enemy-3_frame-2", enemy3Frame2);
    scene.load.image("turret-1_frame-1", turret1Frame1);
    scene.load.image("turret-1_frame-2", turret1Frame2);
    scene.load.image("turret-2_frame-1", turret2Frame1);
    scene.load.image("turret-2_frame-2", turret2Frame2);
    scene.load.image("turret-3_frame-1", turret3Frame1);
    scene.load.image("turret-3_frame-2", turret3Frame2);
  ...
  public createAnimations(scene: Phaser.Scene) {
    scene.anims.create({
      key: "enemy-1_anim",
      frames: [{ key: "enemy-1_frame-1" }, { key: "enemy-1_frame-2" }],
      frameRate: 2,
      repeat: -1,
    });
    ...
    scene.anims.create({
      key: "enemy-2_anim",
      frames: [{ key: "enemy-2_frame-1" }, { key: "enemy-2_frame-2" }],
      frameRate: 2,
      repeat: -1,
    });
    ...
    scene.anims.create({
      key: "enemy-3_anim",
      frames: [{ key: "enemy-3_frame-1" }, { key: "enemy-3_frame-2" }],
      frameRate: 2,
      repeat: -1,
    });
    ...
    scene.anims.create({
      key: "turret-1_anim",
      frames: [{ key: "turret-1_frame-1" }, { key: "turret-1_frame-2" }],
      frameRate: 2,
      repeat: -1,
    });
    ...
    scene.anims.create({
      key: "turret-2_anim",
      frames: [{ key: "turret-2_frame-1" }, { key: "turret-2_frame-2" }],
      frameRate: 2,
      repeat: -1,
    });
    ...
    scene.anims.create({
      key: "turret-3_anim",
      frames: [{ key: "turret-3_frame-1" }, { key: "turret-3_frame-2" }],
      frameRate: 2,
      repeat: -1,
    });
  }
